...
PopupMenuLinks.prototype.init = function () {
    var childElement, menuItem, numItems, label;
    ...
    while (childElement) {
        ...
        menuItem = new MenuItemLinks(childElement, this);
        menuItem.init();
...
PopupMenuLinks.prototype.close = function (force) {
    ...
    if (force || (!this.hasFocus && !this.hasHover && !this.controller.hasHover)) {
        ...
        this.controller.domNode.style.display = 'none'
        // if (this.controller.activeElementBeforeContextMenu) {
        //     this.controller.activeElementBeforeContextMenu.focus()
        // }
        // else {
